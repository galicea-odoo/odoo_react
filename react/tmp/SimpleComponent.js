...
function (_React$Component) {
  ...
  function SimpleComponent() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SimpleComponent).apply(this, arguments));
  }
...
function Demo1Render(param) {
  _reactDom.default.render(_react.default.createElement(SimpleComponent, null), document.getElementById('Demo1'));
}
